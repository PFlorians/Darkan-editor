package darkan.editor.gui.controller
...
import darkan.editor.gui.model.StoreEntryModel
import darkan.editor.gui.model.StoreModel
import java.io.File
...
class MainController : BaseController() {
    ...
    override fun initialize(location: URL, resources: ResourceBundle?) {
        title.text = "Darkan Editor [build ${App.VERSION}]"
